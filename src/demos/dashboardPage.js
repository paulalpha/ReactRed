...
export const supportTicketsData = [
  {
    ...
    date: '30 mins ago',
    text:
      'Hello Im having issues with my toilet. Can it be fixed please.', status: 'pending',
  },
  {
    id: 2,
    avatar: '/img/users/100_2.jpg',
    ...
    date: '1 hour ago',
    text:
      'I was thinking about moving out in May. I wanted to give notice.', status: 'open',
  },
  {
    id: 3,
    avatar: '/img/users/100_3.jpg',
    ...
    date: 'yesterday',
    text:
      'Is it possible for me to sublet my apartment.', status:'open',
  },
];

export const todosData = [
  { id: 1, title: 'Inspection of unit 1940', done: true },
  { id: 2, title: 'Meet with roofing worker', done: false },
  { id: 3, title: 'meet with potential tenant', done: true },
  { id: 4, title: 'Move Roger out', done: true },
  { id: 5, title: 'Answer Toms question about subletting', done: false },
];
